...
if not TRAVIS:
    ...
    class MySeleniumTests(
        ...
        def test_new_subject(self):
            ...
            self.login(
                group_names=self.clinic_user_group_names, site_names=[settings.TOWN]
            )
        ...
        def test_tmg(self):
            ...
            self.login(
                group_names=self.tmg_user_group_names, site_names=[settings.TOWN]
            )
        ...
        def test_to_specimens_clinic(self):
            ...
            self.login(
                group_names=self.lab_user_group_names, site_names=[settings.TOWN]
            )
